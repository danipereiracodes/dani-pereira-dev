...
import { r as resolveSrc, i as isRemoteImage, a as isESMImportedImage, b as isLocalService, D as DEFAULT_HASH_PROPS } from './astro/assets-service_ChynG8E8.mjs';
...
async function getConfiguredImageService() {
  if (!globalThis?.astroAsset?.imageService) {
    const { default: service } = await import(
      // @ts-expect-error
      './astro/assets-service_ChynG8E8.mjs'
    ).then(n => n.s).catch((e) => {
...
const imageBalloon = new Proxy({"src":"/_astro/balloon-cropped.9hulz8e9.png","width":800,"height":312,"format":"png"}, {
...
const imageElefantes = new Proxy({"src":"/_astro/elefantes.DPg7fKWA.png","width":1200,"height":812,"format":"png"}, {
						get(target, name, receiver) {
							if (name === 'clone') {
								return structuredClone(target);
							}
...
const avatar = new Proxy({"src":"/_astro/avatar-dani.BU174AV3.png","width":830,"height":830,"format":"png"}, {
						get(target, name, receiver) {
							if (name === 'clone') {
								return structuredClone(target);
							}
